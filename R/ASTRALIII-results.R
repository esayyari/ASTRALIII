...
ggplot(data=k,aes(x=V4,y=V8))+facet_grid(V5~V2,scales="free_y")+geom_boxplot()+
...
ggplot(data=k,aes(x=V4,y=V8))+facet_grid(V5~V2,scales="free_y")+stat_summary(group=1,geom="point")+
